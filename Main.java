...
public class Main {
    public static void main(String[] args) {
        ...
        Personagem p1 = new Personagem(ent);

        System.out.println("=== CADASTRO DO PLAYER 2");
        Personagem p2 = new Personagem(ent);
        ...
        while (true) {
            ...
            switch (opcao) {
                case 1:
                    luta.desferirSoco(executor, vitima);
                    break;
                case 2:
                    luta.desferirChute(executor, vitima);
                    break;
                case 3:
                    luta.desferirEspecial(executor, vitima);
                    break;
                default:
